...
class Bicycle extends DatabaseObject {
    ...
    public const CATEGORIES = ['Road', 'Mountains', 'Hybrid', 'Cruiser', 'City', 'BMX'];
...
//                if (is_blank($this->$column)) {
//                    $this->errors[] = field_name_as_text($column)." can`t be blank.";
//                }
//            }
//        }
        if (is_blank($this->brand)) {
            $this->errors[] = "Brand can`t be blank.";
        }

        if (is_blank($this->model)) {
            $this->errors[] = "Model can`t be blank.";
        }
